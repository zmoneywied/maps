...
var style_ClinicswithSpecialtyWomensHealthServices_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("womens health — split_fid");
    ...
    if (value >= 0.000000 && value <= 0.100000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.100000 && value <= 145.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
